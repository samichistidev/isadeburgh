 ...
 * Original file: /npm/@studio-freight/lenis@1.0.42/dist/lenis.mjs
 *
...
class n {
  ...
  onWheel = (t) => {
    ...
    (e *= 1 === s ? o : 2 === s ? this.windowWidth : 1),
      (i *= 1 === s ? o : 2 === s ? this.windowHeight : 1),
...
class r {
  constructor({
    ...
    (this.__isSmooth = !1),
      ...
      (this.animate = new e()),
      (this.emitter = new s()),
      (this.dimensions = new i({ wrapper: t, content: o, autoResize: _ })),
...
export { r as default };
//# sourceMappingURL=/sm/9313d297466d535d272597139edf4e1ad240b04bfaf5c7756b79b77afd8e3e01.map
